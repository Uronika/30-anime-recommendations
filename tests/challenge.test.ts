...
import { posterArtwork } from '../src/services/PosterArtwork'
...
describe('challenge template', () => {
  ...
  it('prefers a personal image over an API-provided remote cover', () => {
    ...
    expect(posterArtwork(apiSelection)).toEqual({ imageUrl: 'https://30-anime-recommendations-proxy.30-anime-recommendation.workers.dev/image/subject/1?type=grid', alt: '作品' })
